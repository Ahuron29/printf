...
and prints it to the standard output, much like the C standard library function printf. It can receive a variable number of arguments.
   This function has been created in the context of a first-year project for ALX SE 2022.
   .sp
   .B Return value
   .sp
   ...
   .sp
   .B x, X
   - Respectively print a number in lowercase and uppercase
   .I hexadecimal
   base.
   .sp
   .B o, b
   ...
   .SH AUTHORS
   Ahuron Emmanuel and Acquah Kingsley Segu, Cohort 5.
